...
/**
 * Simple dialog that acts as a help file for Spanish readers.
...
public class HelpDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        textArea.setRows(5);
        textArea.setText("El mando a la izquierda cambia la longitud del barco, y el mando a la derecha cambia el peso de la caja.");
        textArea.setWrapStyleWord(true);
        jScrollPane1.setViewportView(textArea);

        jButton1.setText("Bueno");
